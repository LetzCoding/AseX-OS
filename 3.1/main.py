...
try:
    ...
    print("FATAL: loading un-completed")
    exit(1)
class filestuff():
    def newfile(arg):
        if not arg:
...
class acmd():
    def ver():
        ...
        time.sleep(0.05)
        print(" & &   AseX-OS OS Version:3.1 - FileOp")
        time.sleep(0.05)
