...
while True:
    ...
    if command == 'cmdlist':
        ...
        time.sleep(0.05)
        print('AseX/Commandlist - desktop\AseXOS Desktop')
        time.sleep(0.05)
        ...
        print('AseXOS Desktop 1.0')
        sys.excepthook = cef.ExceptHook
        cef.Initialize()
        cef.CreateBrowserSync(url='https://sprinklelive.github.io/AseXDesktop/index.html', window_title="AseXOS Desktop")
        cef.MessageLoop()
        cef.Shutdown()
